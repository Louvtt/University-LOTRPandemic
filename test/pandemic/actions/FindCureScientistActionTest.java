...
public class FindCureScientistActionTest {
    
    private final static Action a = new FindCureScientistAction();

    // Test the name of the Action
    //inutile mais évite erreur
    @Test
    ...
    public static junit.framework.Test suite() {
        return new junit.framework.JUnit4TestAdapter(pandemic.actions.FindCureScientistActionTest.class);
        }
}